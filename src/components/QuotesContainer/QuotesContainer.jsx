...
const EventsArrayHindi = [
    {
      title : "When you sing and hum from within, you will begin to hear music on the outside too Learn to be happy from within",
    ...
    {
      title : "भगवान् कृष्ण कहते हैं, || बलं बलवतां चाहं ||बलियों का बल मैं हूँ, धनिओं का धन मैं हूँ, अनाथों का नाथ मैं हूँ, रक्षा करने वालों का रक्षक भी मैं हूँ, और जो दुनिया में आनंद फैला रहे हैं उनको आनंद देने वाला भी मैं ही हूँ!",
  ...
  return (
    <div className='middleContainer1'>
        <div className="middleTop">
            <div className="middleTitle">सुधांशु महाराज जी के उद्धरण</div>
            <div className="middleDesc"></div>
