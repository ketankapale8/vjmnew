  ...
  return (
    ...
    <div className='dharmadadonate'>
        <div className="loginContainer">
            <div className="topTitleBox">
                ...
                <div className="titles" >
                    <h2>DHARMADA DONATION FORM</h2>
                    {/* <p>Login to your VJM Profile</p> */}

                </div>

                <div className="inputBox">
                    <h4>As HH Maharajshri always says, Donate 2 to 10% of your monthly income in the Holy Services</h4>
      ...
      <RadioGroup
        ...
        defaultValue="Yearly"
      >
        <FormControlLabel value="Monthly" control={<Radio style={{color: '#b73c1d'}}  />} label="Monthly" />
        <FormControlLabel value="Quarterly" control={<Radio  style={{color: '#b73c1d'}}  />} label="Quarterly" />
        <FormControlLabel value="Halfyearly" control={<Radio style={{color: '#b73c1d'}}   />} label="Halfyearly" />
        <FormControlLabel value="Yearly" control={<Radio style={{color: '#b73c1d'}}   />} label="Yearly" />
...
export default DharmadaDonation